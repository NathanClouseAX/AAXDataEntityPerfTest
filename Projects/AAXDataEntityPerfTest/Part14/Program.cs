...
namespace Part14
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                SalesOrderHeaderV2Tester.createAndDeleteWithSimpleEntity(context, filePath, SalesOrderTester.TestType.Repetitive, SalesOrderTester.TestWorkload.DeleteSimple, "USMF", "US-010");
            }

            for (int i = 0; i < loopCount; i++)
            {
                SalesOrderHeaderV2Tester.createAndDeleteWithCompoundEntity(context, filePath, SalesOrderTester.TestType.Repetitive, SalesOrderTester.TestWorkload.DeleteCompound, "USMF", "US-010");
            }

            for (int i = 0; i < loopCount; i++)
            {
                SalesOrderHeaderV2Tester.createAndDeleteWithSingleEntity(context, filePath, SalesOrderTester.TestType.Repetitive, SalesOrderTester.TestWorkload.DeleteSingle, "USMF", "US-010");
            }
