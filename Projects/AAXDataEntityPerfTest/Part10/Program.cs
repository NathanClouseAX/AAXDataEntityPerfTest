...
namespace Part10
{
    class Program
    {
        ...
        public static string filePath = @"c:\temp\part10-UAT.txt";
        ...
        static void Main(string[] args)
        {
            ...
            {
                SalesOrderHeaderV2Tester.createWithCompoundEntityMinimum(context, filePath, SalesOrderTester.TestType.Repetitive, SalesOrderTester.TestWorkload.CreateCompoundMinimum, "USMF", "US-010");
            }
            

            for (int i = 0; i < loopCount; i++)
            {
                SalesOrderHeaderV2Tester.createWithCompoundEntityMaximum(context, filePath, SalesOrderTester.TestType.Repetitive, SalesOrderTester.TestWorkload.CreateCompoundMaximum, "USMF", "US-010");
            }
