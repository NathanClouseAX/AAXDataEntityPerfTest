...
{
    public class SalesOrderHeaderV2EntityOnlySalesTablePostLoadExtendedTester : SalesOrderTester
    {
        public static string logTemplate = "";
        public static string Entity = "SalesOrderHeaderV2EntityOnlySalesTablePostLoadExtended";
        ...
        public static void runOneRead(Resources context, string filePath, TestType testType, TestWorkload testWorkload, string SalesOrderNumber, string DataAreaId)
        {
            ...
            SalesOrderHeaderV2EntityOnlySalesTablePostLoadExtended SalesOrderHeaderV2EntityOnlySalesTablePostLoadExtended = context.SalesOrderHeadersV2EntityOnlySalesTablePostLoadExtended.Where(x => x.SalesOrderNumber == SalesOrderNumber && x.dataAreaId == DataAreaId).First();
        ...
        public static void runReadWithSelect(Resources context, string filePath, TestType testType, TestWorkload testWorkload, string SalesOrderNumber, string DataAreaId)
        {
            ...
            var SalesOrderHeaderV2EntityOnlySalesTablePostLoadExtended = context.SalesOrderHeadersV2EntityOnlySalesTablePostLoadExtended.Where(x => x.SalesOrderNumber == SalesOrderNumber && x.dataAreaId == DataAreaId)
        ...
        public static void runReadsWithSelect(Resources context, string filePath, TestType testType, TestWorkload testWorkload, string DataAreaId, string customerAccount, int count)
        {
            ...
            context.SalesOrderHeadersV2EntityOnlySalesTablePostLoadExtended.Where(x => x.dataAreaId == DataAreaId && x.OrderingCustomerAccountNumber == customerAccount)
                                                        .Select(x => new { x.SalesOrderNumber, x.OrderingCustomerAccountNumber, x.InvoiceCustomerAccountNumber, x.SalesOrderStatus, x.dataAreaId })
                                                        .Take(count)
                                                        .ToList();
